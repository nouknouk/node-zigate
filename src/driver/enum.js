...
Enum.create('ATTRIBUTE_TYPE', [
	{id: 0x00, name: 'null',       length:0,    },
	{id: 0x08, name: 'data8',      length:1,    },
	{id: 0x09, name: 'data16',     length:2,    },
	{id: 0x0A, name: 'data24',     length:3,    },
	{id: 0x0B, name: 'data32',     length:4,    },
	{id: 0x0C, name: 'data40',     length:5,    },
	{id: 0x0D, name: 'data48',     length:6,    },
	{id: 0x0E, name: 'data56',     length:7,    },
	{id: 0x0F, name: 'data64',     length:8,    },
	{id: 0x10, name: 'boolean',    length:1,    },
	{id: 0x18, name: 'bitmap8',    length:1,    },
	{id: 0x19, name: 'bitmap16',   length:2,    },
	{id: 0x1A, name: 'bitmap24',   length:3,    },
	{id: 0x1B, name: 'bitmap32',   length:4,    },
	{id: 0x1C, name: 'bitmap40',   length:5,    },
	{id: 0x1D, name: 'bitmap48',   length:6,    },
	{id: 0x1E, name: 'bitmap56',   length:7,    },
	{id: 0x1F, name: 'bitmap64',   length:8,    },
	{id: 0x20, name: 'uint8',      length:1,    },
	{id: 0x21, name: 'uint16',     length:2,    },
	{id: 0x22, name: 'uint24',     length:3,    },
	{id: 0x23, name: 'uint32',     length:4,    },
	{id: 0x24, name: 'uint40',     length:5,    },
	{id: 0x25, name: 'uint48',     length:6,    },
	{id: 0x26, name: 'uint56',     length:7,    },
	{id: 0x27, name: 'uint64',     length:8,    },
	{id: 0x28, name: 'int8',       length:1,    },
	{id: 0x29, name: 'int16',      length:2,    },
	{id: 0x2a, name: 'int24',      length:3,    },
	{id: 0x2b, name: 'int32',      length:4,    },
	{id: 0x2c, name: 'int40',      length:5,    },
	{id: 0x2d, name: 'int48',      length:6,    },
	{id: 0x2e, name: 'int56',      length:7,    },
	{id: 0x2f, name: 'int64',      length:8,    },
	{id: 0x30, name: 'enum8',      length:1,    },
	{id: 0x31, name: 'enum16',     length:2,    },
	{id: 0x38, name: 'semiPrec',   length:2,    },
	{id: 0x39, name: 'singlePrec', length:4,    },
	{id: 0x3A, name: 'doublePrec', length:8,    },
	{id: 0x41, name: 'bstring',    length:null, }, // octetStr
	{id: 0x42, name: 'string',     length:null, }, // charStr
	{id: 0x43, name: 'lbstring',   length:null, }, // longOctetStr
	{id: 0x44, name: 'lstring',    length:null, }, // longCharStr
	{id: 0x48, name: 'array',      length:null, },
	{id: 0x4C, name: 'struct',     length:null, },
	...
	{id: 0xF0, name: 'ieee',       length:8,    },
	{id: 0xF1, name: 'seckey',     length:16,   },
	{id: 0xFF, name: 'unknown',    length:0,    },
]);
